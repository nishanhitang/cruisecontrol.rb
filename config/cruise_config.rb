...
Project.configure do |project|
  ...
  project.email_notifier.emails = ['t@gmail.com', 'sadsfgjana@bajratechnologies.com', 'bishasdfnu@bajratechnologies.com']

  # Set email 'from' field to john@doe.com:
  project.email_notifier.from = 'test@email.com'

  # Build the project by invoking rake task 'custom'
  project.rake_task = 'db:migrate spec'
